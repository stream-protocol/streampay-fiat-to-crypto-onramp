...
/**
 * Use `StripeOnramp(publishableKey)` to create an instance of the `StripeOnramp` object.
 * The StripeOnramp object is your entrypoint to the rest of the Stripe Crypto Onramp SDK.
 *
 ...
 */
export interface StripeOnrampConstructor {
  (
    /**
